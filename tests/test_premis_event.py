...
class TestPremisEvent(TestCase):
    ...
    def test_serialization(self):
        ...
        parsed_event = premis.Event.parse(fixture_event_el)
        parsed_event_el = parsed_event.serialize()

        fixture_event_xml = etree.tostring(fixture_event_el, pretty_print=True)
        parsed_event_xml = etree.tostring(parsed_event_el, pretty_print=True)

        assert fixture_event_xml == parsed_event_xml
