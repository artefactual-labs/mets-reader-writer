...
class Object(object):
    ...
    def __init__(self, object_identifiers, object_category, preservation_levels=None, significant_properties=None, characteristics=None, original_name=None, storage=None, environments=None, signature_information=None, relationships=None, linking_event_identifiers=None, linking_intellectual_entity_identifiers=None, linking_rights_statement_identifiers=None):
        ...
        if object_category is None:
            raise exceptions.ConstructError('object_cateogory argument is required.')
    ...
    def parse(cls, root):
        ...
        return cls(object_identifiers, object_category, preservation_levels, significant_properties, characteristics, original_name, storage, environments, signature_information, relationships, linking_event_identifiers, linking_intellectual_entity_identifiers, linking_rights_statement_identifiers)
